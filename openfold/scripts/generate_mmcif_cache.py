...
sys.path.insert(0, ".") # in order to access mmcif_parsing.py in the current working dir instead of conda envs 

from tqdm import tqdm

from openfold.data.mmcif_parsing import parse 
import openfold.data.mmcif_parsing
...
def parse_file(f, args):
    ...
    print("incoming! "+ str(openfold.data.mmcif_parsing.__file__))
