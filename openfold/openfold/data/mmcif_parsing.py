...
def parse(
    *, file_id: str, mmcif_string: str, catch_all_errors: bool = True
    ...
    # valid_chains = _get_protein_chains(parsed_info=parsed_info)
    # for chain_id, seq in valid_chains.items():
    #     author_chain_to_sequence[chain_id] = "".join(seq)
    ...
    # print("mmcif_object: "+ str(mmcif_object))
...
def _get_protein_chains(
    *, parsed_info: Mapping[str, Any]
    ...
    for entity_id, seq_info in polymers.items():
        ...
        valid_chains["A"] = seq_info
    return valid_chains
    
    
    # seq = parsed_info["_entity_poly.pdbx_seq_one_letter_code"]
    # seq = seq[0].strip(";")
    # return {'A': list(seq)} 
